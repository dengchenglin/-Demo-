...
//{
//    CustomOverlayRenderer *customOverlayRenderer = [[CustomOverlayRenderer alloc]initWithOverlay:overlay];
//
//    
//    customOverlayRenderer.strokeColor = [UIColor redColor];
//    customOverlayRenderer.fillColor = [UIColor yellowColor];
//    
//    
...
-(void)addCircle{
    ...
    circle = [MKCircle circleWithCenterCoordinate:droppedAt radius:100];
