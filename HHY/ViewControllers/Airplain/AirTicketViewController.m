...
//    从高度60开始
    ...
    _startPointBT.typeLable.textColor = [JJDevice colorWithR:100 G:100 B:100 A:1];
    ...
    [_startDateBT decideIsToday:nowDayModel.description];
...
-(void)changeDateStarting:(DayModel *)day
{
    ...
    if ([day.selfDate laterDate:self.endingDay.selfDate]) {
        [self changeDateEnd:day];
    }
}
