...
-(void)change;
@end
@interface AddPlainRangeViewController : RootViewController<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,ChangYongPersonViewControllerDelegate,UIActionSheetDelegate,UIAlertViewDelegate>
{
